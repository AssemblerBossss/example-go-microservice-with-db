...
Проект демонстрирует правильную организацию кода, разделение ответственности, использование интерфейсов для абстракции
инфраструктуры и внедрение зависимостей.
...
Проект представляет собой минимальный API-сервер, который возвращает текущее время с использованием разных источников (
системное время или время из БД).
...
│ │   └── id_gen.go # IDGenerator интерфей
│ ├── infra
│ │        ├── sqlite_clock
